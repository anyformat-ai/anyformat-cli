...
import (
	...
	"github.com/anyformat-ai/anyformat-cli/pkg/cmd"
...
func main() {
	...
	if baseURL, ok := os.LookupEnv("ANYFORMAT_BASE_URL"); ok {
		if err := cmd.ValidateBaseURL(baseURL, "ANYFORMAT_BASE_URL"); err != nil {
